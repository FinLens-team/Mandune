...
- Data management has no cancel action; saving returns to home, while cross-page navigation for data management, history, atlas, and about goes through the persistent drawer trigger.
