...
export const EASTER_EGG_AUDIO_THEMES: Readonly<Record<ThemeId, EasterEggAudioTheme>> = {
  ...
  zhouli: {
    label: "周礼雅乐",
    samples: [
      sample("dingdongji_ding", "礼", 68.72369809072657, [74, 72, 69, 67], 2.5889190244772604),
      sample("dingdongji_dong", "乐", 68.20736701647688, [74, 72, 69, 67], 2.3637451111911507),
      sample("dingdongji_ji", "和", 69.48535473104747, [74, 72, 69, 67], 2.3501763429894065),
    ],
  },
  tieba_laoge: {
    label: "老哥开麦",
    samples: [
      sample("da", "典", 71.1950846771, [79, 76, 72, 69], 1),
      sample("gou", "绷", 65.5950930881, [72, 69, 67, 64], 1.012898017161218),
      sample("jiao", "急", 71.1226079346, [79, 76, 72, 69], 0.953577156471302),
    ],
  },
  male_succubus: {
    label: "夜色耳语",
    samples: [
      sample("ha", "靠", 72.732, [81, 79, 76, 72], 1.283378415934229),
      sample("ji", "近", 67.55506219280217, [74, 72, 69, 67], 1.4777851484035351),
      sample("mi", "我", 65.47641325112846, [72, 69, 67, 64], 1.4846115949156913),
    ],
  },
  female_succubus: {
    label: "魅惑召见",
    samples: [
      sample("ha", "看", 72.732, [81, 79, 76, 72], 1.283378415934229),
      sample("ji", "着", 67.55506219280217, [74, 72, 69, 67], 1.4777851484035351),
      sample("mi", "我", 65.47641325112846, [72, 69, 67, 64], 1.4846115949156913),
    ],
  },
};
