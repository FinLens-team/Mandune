...
完整说明最近三个有效交易日的逐日变化和区间涨跌、确定性派生、组合结构、风险、未知边界和方向性观察；某持仓不足三个有效交易日时必须明确数据不足，不得形成趋势判断。不要复述 skill 中的每日学习内容。
...
理性报告使用正式、克制、清晰的分析师口吻，按整体情况、逐项分析、风险与缺口、方向性观察组织。每项持仓有最近三个有效交易日行情时，必须比较三个观察值并说明逐日及区间涨跌；不足三个有效交易日时明确数据不足，不作趋势判断。
