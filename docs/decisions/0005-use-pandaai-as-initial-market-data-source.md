...
- Status: Accepted
- Date: 2026-07-24
- Ticket: #24 / MD-002（权限探测）；#29 / MD-007（证据接入）
...
选择 PandaAI 作为 #29 / MD-007 的初始真实结构化数据上游，所有请求和响应必须隐藏在版本化、供应商中立的证据适配器后。示例与确定性 fixture（#25 / MD-003）默认不依赖 PandaAI，不把 PandaAI 可用性作为公开演示前提。
...
- A 股、ETF、场外基金、鉴权、限流、超时、畸形响应、修订和冲突仍须分别完成 #24 / MD-002 与 #29 / MD-007 运行验收。
